...
<body>
 <form id="myform" action="Traderhomecontroller1" method="POST">
<nav id="nav-bar" class="navbar navbar-default">
  ...
  <div class="navbar-form navbar-left">
        ...
        <ul style="font-size:2rem  font-family: 'Economica', sans-serif;" class="dropdown-menu">
          <li style="font-size:2rem  font-family: 'Economica', sans-serif;"><a href="traderupdatedetails.jsp">Update details</a></li>
                    <li style="font-size:2rem  font-family: 'Economica', sans-serif;"><a href="traderprofilesearch.jsp">Search By profiles</a></li>
          <li style="font-size:2rem  font-family: 'Economica', sans-serif;"><a href="traderaddproduct.jsp">Add a Product</a></li>
