...
<p style="font-family: 'Economica', cursive;font-size:2rem;color:grey;">REGISTRATION IN CUSTOMER COMMUNITY</p>
</div>
</div>
<div class="row">
...
<p style=" width:100%;font-family: 'Economica', cursive;font-size:1.7rem;color:grey;">
  <b>Note:</b>
  The mobile number given above receives an OTP during registration.Give the valid mobile number.Remember the user name and password.</p>
 </td>
 </tr>
